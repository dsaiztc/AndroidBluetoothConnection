 ...
 * by the user, the MAC address of the device is sent back to the parent Activity in the result Intent.
 */
public class DeviceListActivity extends Activity
{
	...
	private OnItemClickListener mDeviceClickListener = new OnItemClickListener()
	{
		...
		{
			if (D) Log.i(TAG, "OnItemClickListener: onItemClick");
	...
	private final BroadcastReceiver mReceiver = new BroadcastReceiver()
	{
		...
		{
			if (D) Log.i(TAG, "BroadcastReceiver: onReceive");

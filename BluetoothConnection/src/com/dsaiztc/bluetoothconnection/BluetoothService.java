...
/**
 * This class does all the work for setting up and managing Bluetooth connections with other devices. It has a thread for performing data
...
public class BluetoothService
{
	...
	// Connection errors
	protected static final int UNABLE_TO_CONNECT = 0;
	protected static final int CONNECTION_LOST = 1;
	...
	{
		if (D) Log.i(TAG, "connectionFailed");
		// Send a failure message back to the Activity
		Message msg = mHandler.obtainMessage(BluetoothConnection.MESSAGE_TOAST);
		Bundle bundle = new Bundle();
		bundle.putInt(BluetoothConnection.TOAST, UNABLE_TO_CONNECT);
		msg.setData(bundle);
		mHandler.sendMessage(msg);
	}
	...
	private void connectionLost()
	{
		...
		Message msg = mHandler.obtainMessage(BluetoothConnection.MESSAGE_TOAST);
		Bundle bundle = new Bundle();
		bundle.putInt(BluetoothConnection.TOAST, CONNECTION_LOST);
		msg.setData(bundle);
		mHandler.sendMessage(msg);
	}
	...
	private class ConnectedThread extends Thread
	{
		...
		{
			Log.i(TAG, "ConnectedThread: " + socketType);
			mmSocket = socket;
